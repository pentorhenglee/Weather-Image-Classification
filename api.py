"""
FastAPI application for Weather Classification Model
...
async def startup_event():
    ...
    logger.info("Starting Weather Classifier API...")
    load_model()
...
async def root():
    ...
    return {
        "message": "Weather Classifier API",
        "version": "1.0.0",
        "endpoints": {
...
async def predict_weather(file: UploadFile = File(...)):
    """
    Classify weather condition from uploaded image
